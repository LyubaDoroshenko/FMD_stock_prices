library("renv")
#You need to create a Python virtual invironment in order to be able
#to use keras and tensorflow 
...
for(i in 1:length(list_entire_fin)){
  ...
  Series[[i]][[length(training_cv[[i]])]]=list_training[[i]]$Price #the last test period is smaller than half a year
...
n_steps=c(40,50,60,250)#timesteps
...
#Split datasetinto training and testing sets
N=n=c()
...
batch_size = 32                # must be a common factor of both the train and test samples                    # can adjust this, in model tuninig phase
x_train_new=x_train
y_train_new=y_train
for(i in 1:length(list_entire_fin)){
  for(s in 1:length(n_steps)){
...
#            dropout = dropouts[[d]]
#          ) %>%
#          layer_dense(units = 1,activation="linear")#we consider the linear activation function
#        #Compile the model
#        model %>% compile(
...
#          yhat_original[[i]][[s]][[d]][[j]][[l]] = tail((model %>% predict(X[[i]][[s]][[j]][[l]],batch_size=batch_size)),1)
#          #invert scaling
...
#rmse_dropout_01_250=rmse_dropout_02_250=rmse_dropout_03_250=rmse_dropout_04_250=
#  rmse_dropout_05_250=rmse_dropout_06_250=rmse_dropout_07_250=rmse_dropout_08_250=
#  rmse_dropout_09_250=list()
...
#  rmse_dropout_01_250[[i]]=rmse_dropout_02_250[[i]]=rmse_dropout_03_250[[i]]=rmse_dropout_04_250[[i]]=
#    rmse_dropout_05_250[[i]]=rmse_dropout_06_250[[i]]=rmse_dropout_07_250[[i]]=rmse_dropout_08_250[[i]]=
#    rmse_dropout_09_250[[i]]=list()
...
#  rmse_dropout_01_250[[i]]=rmse_fin[[i]][[4]][[1]]
#  rmse_dropout_02_250[[i]]=rmse_fin[[i]][[4]][[2]]
#  rmse_dropout_03_250[[i]]=rmse_fin[[i]][[4]][[3]]
#  rmse_dropout_04_250[[i]]=rmse_fin[[i]][[4]][[4]]
#  rmse_dropout_05_250[[i]]=rmse_fin[[i]][[4]][[5]]
#  rmse_dropout_06_250[[i]]=rmse_fin[[i]][[4]][[6]]
#  rmse_dropout_07_250[[i]]=rmse_fin[[i]][[4]][[7]]
#  rmse_dropout_08_250[[i]]=rmse_fin[[i]][[4]][[8]]
#  rmse_dropout_09_250[[i]]=rmse_fin[[i]][[4]][[9]]
#}
...
#                    RMSE_01_250=unlist(rmse_dropout_01_250),
#                    RMSE_02_250=unlist(rmse_dropout_02_250),RMSE_03_250=unlist(rmse_dropout_03_250),
#                    RMSE_04_250=unlist(rmse_dropout_04_250),RMSE_05_250=unlist(rmse_dropout_05_250),
#                    RMSE_06_250=unlist(rmse_dropout_06_250),RMSE_07_250=unlist(rmse_dropout_07_250),
#                    RMSE_08_250=unlist(rmse_dropout_08_250),RMSE_09_250=unlist(rmse_dropout_09_250))
...
#    yhat_original[[i]][[j]] = tail((model %>% predict(X[[i]][[j]],batch_size=batch_size)),1)#, batch_size=batch_size
#    # invert scaling
...
load("./lstm_data/model1_lin_predictions.Rdata",model1_lin_predictions <- new.env())
predictions_final=model1_lin_predictions$model1_lin_predictions
