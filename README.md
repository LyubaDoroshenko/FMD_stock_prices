...
The folders `Simulation_study_1`, `Simulation_study_2` and `Empirical_analysis` enclose codes of the simulation studies and empirical analysis, respectively. 

## Simulation study 1

The folder `Simulation_study_1` encloses the following files and folders:

- `simulations_derivative_amplitude_sim4_new_probKMA.r` - R code for running the extended version of functional motif discovery (FMD) and search on the simulated data of `Simulation4` (see Section "Simulation study 1"). The directory `N20_K2-10-10_derivative_amplitude_new_probKMA/simulation4` contains the candidate motifs resulting from ProbKMA-FMD and the final results.

- `simulations_derivative_amplitude_sim4_old_probKMA.r` - R code for running the original version of functional motif discovery (FMD) and search on the simulated data of `Simulation4` (see Section "Additional details on simulation study 1"). The directory `N20_K2-10-10_derivative_amplitude_old_probKMA/simulation4` contains the candidate motifs resulting from ProbKMA-FMD and the final results. 

- `simulations_derivative_amplitude_sim10_new_probKMA.r` - R code for running the extended version of functional motif discovery (FMD) and search on the simulated data of `Simulation10` (see Section "Additional details on simulation study 1"). The directory `N20_K2-10-10_derivative_amplitude_new_probKMA/simulation10` contains the candidate motifs resulting from ProbKMA-FMD and the final results.

- `simulations_derivative_amplitude_sim10_old_probKMA.r` - R code for running the original version of functional motif discovery (FMD) and search on the simulated data of `Simulation10` (see Section "Additional details on simulation study 1"). The directory `N20_K2-10-10_derivative_amplitude_old_probKMA/simulation10` contains the candidate motifs resulting from ProbKMA-FMD and the final results. 
## Simulation study 2

The folder `Simulation_study_2` encloses the following files and folders:
